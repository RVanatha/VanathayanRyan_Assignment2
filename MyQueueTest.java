...
public class MyQueueTest {
	...
	public void setUp() throws Exception {
		...
		doubleS = new MyQueue<Double>();
		doubleS.enqueue(77.9);
		doubleS.enqueue(12.4);
		doubleS.enqueue(90.3);
		
		doubleQ = new MyQueue<Double>(5);
		doubleQ.enqueue(12.3);
		doubleQ.enqueue(45.6);
		doubleQ.enqueue(78.9);
	}
	...
	public void testDequeueStudent() {
		try {
			assertEquals(77.9, doubleS.dequeue());
			assertEquals(12.4, doubleS.dequeue());
			assertEquals(90.3, doubleS.dequeue());
			//Queue is empty, next statement should cause QueueUnderFlowException
			doubleS.dequeue();
			assertTrue(false, "This should have caused an QueueUnderflowException");
		}
	...
	public void testEnqueueStudent() {
		try {
			...
			assertEquals(true, doubleQ.enqueue(dQ));
			assertEquals(4, doubleQ.size());
			assertEquals(true, doubleQ.enqueue(eQ));
	...
	public void testToStringStudent() throws QueueOverflowException {
		assertEquals("12.345.678.9", doubleQ.toString());
		doubleQ.enqueue(dQ);
		assertEquals("12.345.678.967.8", doubleQ.toString());
		doubleQ.enqueue(eQ);
		assertEquals("12.345.678.967.889.0", doubleQ.toString());
	}
